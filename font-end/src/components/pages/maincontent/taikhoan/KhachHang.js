            ...
            <div className="">
                <div className="p-[20px]">
                    <div className="title mb-[20px]">
                        ...
                        <span className="text-[22px] font-bold ml-[10px]">Quản lý tài khoản khách hàng</span>
                    </div>
                        ...
                        <div className="p-[10px]">
                            <div className="mb-[20px] flex justify-between">
                                <div className="">
                                    ...
                                    <span className="text-[17px] font-[500] ml-[5px]">Danh sách khách hàng</span>
                                </div>
                                <div>
                            ...
                            <div>
                                <table className="w-full text-[14px]">
                                    ...
                                    <tr className="">
                                        ...
                                        <td className="text-center px-4 py-[15px]">
                                            <i className="fa-regular fa-eye py-[7px] px-[17px] rounded-[5px] bg-[#e48902] text-[#fff] cursor-pointer"></i>
                                            <i className="fa-regular fa-pen-to-square py-[7px] px-[17px] rounded-[5px] bg-[#0189e5] text-[#fff] cursor-pointer ml-[5px]"></i>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
